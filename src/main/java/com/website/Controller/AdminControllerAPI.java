...
//  ====================================================== Ngữ pháp ========================================================= //
	// - Lấy all Nguphap theo IDmina;
	// truyền vào id
	@GetMapping("/rest/mina_nguphap/{id}")
	public Iterable<Nguphap> getByIDNP2(@PathVariable("id") Integer id) {
		return (Iterable<Nguphap>) nguphapRPS.findByIDNP2(id);
	};
