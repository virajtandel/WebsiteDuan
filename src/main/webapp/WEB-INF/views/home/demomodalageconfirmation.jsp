            ...
            <div class="col-auto">
                ...
                <!-- desctop menu -->
                  <div class="tt-desktop-menu">
                    <nav>
                        <ul>
                            <li><a href="pagecategories"><span>Categories</span></a></li>
                            <li><a href="pagetabs"><span>Trending</span></a></li>
                            <li><a href="pagecreatetopic"><span>New</span></a></li>
                            <li>
                                <a href="pagesingleuser"><span>Pages</span></a>
                                <ul>
                                    <li><a href="index">Home</a></li>
                                    <li><a href="pagesingletopic">Single Topic</a></li>
                                    <li><a href="pagecreatetopic">Create Topic</a></li>
                                    <li><a href="pagesingleuser">Single User Activity</a></li>
                                    <li><a href="pagesinglethreads">Single User Threads</a></li>
                                    <li><a href="pagesinglereplies">Single User Replies</a></li>
                                    <li><a href="pagesinglefollowers">Single User Followers</a></li>
                                    <li><a href="pagesinglecategories">Single User Categories</a></li>
                                    <li><a href="pagesinglesettings">Single User Settings</a></li>
                                    <li><a href="pagesignup">Sign up</a></li>
                                    <li><a href="pagelogin">Log in</a></li>
                                    <li><a href="pagecategories">Categories</a></li>
                                    <li><a href="pagecategoriessingle">Single Category</a></li>
                                    <li><a href="pagetabs">About</a></li>
                                    <li><a href="pagetabsguidelines">Guidelines</a></li>
                                    <li><a href="demomodaladvancedSearch">Advanced Search</a></li>
                                    <li><a href="error404">Error 404</a></li>
                                    <li><a href="demomodalageconfirmation">Age Verification</a></li>
                                    <li><a href="demomodallevelup">Level up Notification</a></li>
                                    <li><a href="messagespage">Message</a></li>
                                    <li><a href="messagescompose">Message Compose</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
