            ...
            <div class="row tt-row no-gutters">
                        ...
                        <form class="search-wrapper">
                            ...
                            <div class="search-results">
                                ...
                                <button type="button" class="tt-view-all" data-toggle="modal"
                                    data-target="#modalAdvancedSearch">Tìm kiếm mở rộng</button>
                            </div>
                        </form>
                    </div>
                    <!-- /tt-search -->
                ...
                <div class="col-auto ml-auto">
                    <div class="tt-account-btn">
                        <a href="pagelogin" class="btn btn-primary">Đăng nhập</a>
                        <a href="pagesignup" class="btn btn-secondary">Đăng kí</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="tt-topic-list">
                <div class="tt-list-header">
                    ...
                    <div class="tt-col-value hide-mobile">Phản hồi</div>
                    <div class="tt-col-value hide-mobile">Lượt xem</div>
                    <div class="tt-col-value">Hoạt động</div>
                </div>
                <div class="tt-topic-alert tt-alert-default" role="alert">
                    <a href="#" target="_blank">4 bài viết mới</a> gần đây, nhấn để tải lại.
                </div>
                <div class="tt-item tt-itemselect">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="page-single-topic.html" style="color:red">
                                <svg class="tt-icon">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color01 tt-badge">Top</span></a>
                                    </li>
                                    <li><a href="#"><span class="tt-badge">thông báo</span></a></li>
                                    <li><a href="#"><span class="tt-badge">admin</span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="tt-col-category"><span class="tt-color01 tt-badge">Top</span></div>
                ...
                <div class="tt-item tt-itemselect">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="page-single-topic.html" style="color:green">
                                <svg class="tt-icon">
                                    <use xlink:href="#icon-pinned"></use>
                                </svg>
                ...
                <div class="tt-item tt-itemselect">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="page-single-topic.html" style="color:blue">
                                <svg class="tt-icon">
                                    <use xlink:href="#icon-pinned"></use>
                                </svg>
                                Thắc mắc, góp ý
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    ...
                                    <li><a href="#"><span class="tt-badge">hỏi đáp</span></a></li>
                                    <li><a href="#"><span class="tt-badge">thắc mắc</span></a></li>
                                </ul>
                            </div>
                            <div class="col-1 ml-auto show-mobile">
                                <div class="tt-value">2h</div>
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="pagesingletopic">
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color07 tt-badge">Giải
                                                trí</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Giải trí</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Game</span></a></li>
                                </ul>
                            </div>
                            <div class="col-1 ml-auto show-mobile">
                                <div class="tt-value">2d</div>
                    ...
                    <div class="tt-col-category"><span class="tt-color07 tt-badge">Giải trí</span></div>
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="pagesingletopic">
                                ...
                                Những điều cần biết khi mới sang Nhật
                            </a></h6>
                        <div class="row align-items-center no-gutters hide-desktope">
                            <div class="col-11">
                                <ul class="tt-list-badge ">
                                    <li class="show-mobile"><a href="#"><span class="tt-color08 tt-badge">Chia
                                                sẻ</span></a></li>
                                </ul>
                            </div>
                            <div class="col-1 ml-auto show-mobile">
                    ...
                    <div class="tt-col-category"><span class="tt-color08 tt-badge">Chia sẻ</span></div>
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="pagesingletopic">
                                Có ai ở Tokyo không ạ, hôm nào mình rủ đi ăn chè !!
                            </a></h6>
                        <div class="row align-items-center no-gutters  hide-desktope">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color09 tt-badge">Thắc
                                                mắc</span></a></li>
                                </ul>
                            </div>
                            <div class="col-1 ml-auto show-mobile">
                    ...
                    <div class="tt-col-category"><span class="tt-color09 tt-badge">Thắc mắc</span></div>
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="pagesingletopic">
                                ...
                                Mình viết như thế này đã đúng chưa ạ
                            </a></h6>
                        <div class="row align-items-center no-gutters">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color10 tt-badge">Thắc
                                                mắc</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Ngữ pháp</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Từ vựng</span></a></li>
                                </ul>
                            </div>
                            <div class="col-1 ml-auto show-mobile">
                                <div class="tt-value">3d</div>
                    ...
                    <div class="tt-col-category"><span class="tt-color10 tt-badge">Thắc mắc</span></div>
