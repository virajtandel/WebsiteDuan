    ...
    <main id="tt-pageContent">
        <div class="tt-custom-mobile-indent container">
            <div class="tt-categories-title">
                <div class="tt-title">Các danh mục</div>
                <div class="tt-search">
                    <form class="search-wrapper">
                        <div class="search-form">
                ...
                <div class="row">
                        ...
                        <div class="tt-item">
                            <div class="tt-item-header">
                                <ul class="tt-list-badge">
                                    <li><a href="#"><span class="tt-color01 tt-badge">Thảo luận</span></a></li>
                                </ul>
                                <h6 class="tt-title"><a href="page-categories-single.html">Threads - 1,245</a></h6>
                            </div>
                            <div class="tt-item-layout">
                                <div class="innerwrapper">
                                    Thảo luận về kinh nghiệm học tiếng Nhật hiệu quả
                                </div>
                                <div class="innerwrapper">
                                    <h6 class="tt-title">Tags tương tự</h6>
                                    <ul class="tt-list-badge">
                                        <li><a href="#"><span class="tt-badge">Ngữ pháp</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Từ vựng</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Cách luyện nghe</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Cách luyện phát âm</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Cách ghi nhớ</span></a></li>
                                    </ul>
                                </div>
                                <a href="#" class="tt-btn-icon">
                                    <i class="tt-icon"><svg>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="tt-item">
                            <div class="tt-item-header">
                                <ul class="tt-list-badge">
                                    <li><a href="#"><span class="tt-color02 tt-badge">Giải trí</span></a></li>
                                </ul>
                                <h6 class="tt-title"><a href="page-categories-single.html">Threads - 368</a></h6>
                            </div>
                            <div class="tt-item-layout">
                                <div class="tt-innerwrapper">
                                    Tổng hợp game giải trí bằng tiếng Nhật
                                </div>
                                <div class="tt-innerwrapper">
                                    ...
                                    <ul class="tt-list-badge">
                                        ...
                                        <li><a href="#"><span class="tt-badge">Nhạc</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Video</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Thư giãn</span></a></li>
                                    </ul>
                                </div>
                                <div class="tt-innerwrapper">
                                    <a href="#" class="tt-btn-icon">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="tt-item">
                            <div class="tt-item-header">
                                <ul class="tt-list-badge">
                                    <li><a href="#"><span class="tt-color03 tt-badge">Khảo sát</span></a></li>
                                </ul>
                                <h6 class="tt-title"><a href="page-categories-single.html">Threads - 381</a></h6>
                            </div>
                            <div class="tt-item-layout">
                                <div class="tt-innerwrapper">
                                    Khảo sát cho các bạn học tiếng Nhật
                                </div>
                                <div class="tt-innerwrapper">
                                    <h6 class="tt-title">Similar TAGS</h6>
                                    <ul class="tt-list-badge">
                                        <li><a href="#"><span class="tt-badge">Khoa học</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Nghiên cứu</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Số liệu</span></a></li>
                                        <li><a href="#"><span class="tt-badge">Thống kê</span></a></li>
                                    </ul>
                                </div>
                                <div class="tt-innerwrapper">
                                    <a href="#" class="tt-btn-icon">
