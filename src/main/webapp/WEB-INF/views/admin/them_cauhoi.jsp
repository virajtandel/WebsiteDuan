		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-cau-hoi" modelAttribute="addCauHoi"
						method="POST">

						<div class="form-group">
							<label for="exampleInputEmail1">Nội dung câu hỏi</label>
							<form:input path="ndcauhoi" cssClass="form-control" required="true"/>

						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Âm thanh</label>
							<form:input path="audioch" cssClass="form-control" required="true"/>
