		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-baihoc" modelAttribute="updateBaiHoc"
						method="POST">
						<div class="form-group">
							<form:input path="idbaihoc" cssClass="form-control" type="hidden" />

						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Tên bài học</label>
							<form:input path="tenbaihoc" cssClass="form-control" required="true"/>

						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Nội Dung Bài Học</label>
							<form:textarea path="noidungbh" class="form-control" type="text"/>
						</div>
