	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Cập Nhật Đáp Án</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-dap-an" modelAttribute="updateDapan"
						method="POST">
						<div class="form-group">
							<form:input path="iddapan" cssClass="form-control" type="hidden"/>

						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Câu hỏi</label>
							<form:select path="cauhoi.idcauhoi" cssClass="form-control">
								<form:options items="${showCBBCauHoi}" />
							</form:select>
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">Đáp án</label>
							<form:textarea path="dapan" cssClass="form-control" />
