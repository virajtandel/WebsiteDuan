		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-user" modelAttribute="updateUser"
						method="POST">
						...
						<div class="form-group">
							...
							<form:input type="password" path="password" cssClass="form-control" id="myInput" />
							<input type="checkbox" onclick="myFunction()">Show
							Password
						</div>
						<div class="form-group">
							<label>Họ tên</label>
							<form:input path="hoten" cssClass="form-control" id="myInput" />
						</div>
						<div class="form-group">
