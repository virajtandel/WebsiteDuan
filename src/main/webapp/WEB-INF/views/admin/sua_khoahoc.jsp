	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Cập Nhật Khóa Học</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-khoa-hoc" modelAttribute="updateKhoaHoc"
						method="POST">
						<div class="form-group">
							<form:input path="idkhoahoc" cssClass="form-control" type="hidden"/>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Tên khóa học</label>
							<form:input path="tenkhoahoc" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Thời gian</label>
							<form:input type="number" path="thoigian" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Học phí</label>
							<form:input type="number" path="hocphi" cssClass="form-control"  required="true"/>
						</div>
						<div class="form-group">
							<label for="loaikhoahoc">Loại khóa học</label>
							<form:select path="loaikhoahoc" cssClass="form-control">
								 <form:option value="Sơ cấp" label="Sơ cấp"/>
								 <form:option value="Trung cấp" label="Trung cấp"/>
						 		 <form:option value="Cao cấp" label="Cao cấp"/>
						 		 <form:option value="Chuyên gia" label="Chuyên gia"/>
							</form:select>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Ngày Tạo</label>
							<form:input type="date" path="ngaytao" cssClass="form-control" required="true"/>
						</div>
