	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Thêm Giáo Trình</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-giao-trinh" modelAttribute="addGiaoTrinh"
						method="POST">
						<div class="form-group">
							<label for="exampleInputEmail1">Tên giáo trình</label>
							<form:input path="tengiaotrinh" cssClass="form-control" required="true"/>
