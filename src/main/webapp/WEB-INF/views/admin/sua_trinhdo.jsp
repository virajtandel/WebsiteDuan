	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Cập Nhật Trình Độ</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-trinh-do" modelAttribute="updateTrinhDo"
						method="POST">
						<div class="form-group">
							<form:input path="idtrinhdo" cssClass="form-control" type="hidden" />
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Tên trình độ</label>
							<form:input path="tentrinhdo" cssClass="form-control" />
						</div>
						<div class="form-group">
