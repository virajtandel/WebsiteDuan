		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-tin-tuc"
						modelAttribute="updateTinTuc" enctype="multipart/form-data"
						method="POST">
						<div class="form-group">
							<form:input path="idtintuc" cssClass="form-control" type="hidden" />
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">User name</label>
							<form:select path="user.id" cssClass="form-control">
								<form:options items="${showCBBUser}" />
							</form:select>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<form:textarea path="noidung" cssClass="form-control" />
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Hình ảnh</label> <input
								type="file" name="uploadFiles" class="form-control" id="imgInp" />
							<img alt="" id="blah" src="/files/${hinhanh}" width="60%"
								class="mx-auto d-block mt-3">

						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Lượt xem</label>
							<form:input type="number" path="luotxem" cssClass="form-control" />
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Ngày đăng</label>
							<form:input type="date" path="ngaydang" cssClass="form-control" />
						</div>
						...
						<input type="hidden" value="${hinhanh}" name="hinhtruocDo">
					</form:form>
				</div>
			</div>
		</div>
