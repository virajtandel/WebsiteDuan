...
<title>Cập Nhật Bảng Bài Học Thử</title>
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Cập Nhật Bảng Học Thử</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-hoc-thu" modelAttribute="updateHocThu" method="POST">
						<div class="form-group">
							<form:input path="idhocthu" id="id" name="id" cssClass="form-control"  hidden="true"/>
						</div>
						<div class="form-group" >
						...
						<div class="form-group">
							...
							<form:select path="chitietkhoahoc.idctkh" cssClass="form-control" hidden="true">
