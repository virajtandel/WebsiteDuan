...
<title>Cập Nhật Chi Tiết Bài Tập</title>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-chi-tiet-bai-tap"
						modelAttribute="updateChiTietBaiTap" method="POST">
						
						<div class="form-group">
							<form:input path="idctbt" cssClass="form-control" />
						...
						<div class="form-group">
							...
							<form:input path="audiobt" type="file" cssClass="form-control" />
