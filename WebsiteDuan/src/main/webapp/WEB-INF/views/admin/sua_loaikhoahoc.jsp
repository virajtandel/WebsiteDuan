...
<title>Cập Nhật Loại Khóa Học</title>
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Cập Nhật Loại Khóa Học</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-loai-khoa-hoc" modelAttribute="updateLoaiKhoaHoc"
						method="POST">
						<div class="form-group">
							<form:input path="idloaikh" cssClass="form-control" type="hidden" />
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Tên loại khóa học</label>
							<form:input path="tenloaikh" cssClass="form-control" />
						</div>
						<div class="form-group">
