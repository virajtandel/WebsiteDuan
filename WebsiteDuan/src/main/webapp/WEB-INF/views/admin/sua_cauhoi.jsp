		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-cauhoi" modelAttribute="updateCauHoi"
						method="POST">
						<div class="form-group">
							<form:input path="idcauhoi" cssClass="form-control" type="hidden" />

						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Nội dung câu hỏi</label>
							<form:input path="ndcauhoi" cssClass="form-control" />

						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Âm thanh</label>
							<form:input path="audioch" cssClass="form-control" />

						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Tên bài test</label>
							<form:select path="baitest.idbaitest" cssClass="form-control">
								<form:options items="${showTenBaiTest}" />
							</form:select>
						</div>
