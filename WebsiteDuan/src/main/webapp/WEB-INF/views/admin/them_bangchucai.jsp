	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Thêm Bảng Chữ Cái</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-bang-chu-cai"
						modelAttribute="addBangChuCai" method="POST" enctype="multipart/form-data">
						<div class="form-group" >
							...
							<img alt="" id="blah1" src="" width="30%" class="mx-auto d-block mt-3">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Romanjji</label>
							<form:input path="romajji" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<img alt="" id="blah" src="" width="30%" class="mx-auto d-block mt-3">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Ví dụ 1</label>
							<form:input path="vidu1" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Ví dụ 2</label>
							<form:input path="vidu2" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Ví dụ 3</label>
							<form:input path="vidu3" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
