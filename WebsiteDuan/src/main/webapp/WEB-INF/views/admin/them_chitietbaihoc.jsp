...
<title>Thêm Chi Tiết Bài Học</title>
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Thêm Chi Tiết Bài Học</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-chi-tiet-bai-hoc" modelAttribute="addChiTietBaiHoc"
						method="POST">
