	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Thêm Hình Thức Thanh Toán</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-hinh-thuc-thanh-toan" modelAttribute="addHinhThucTT"
						method="POST">
						<div class="form-group">
							<label for="exampleInputEmail1">Tên hình thức TT</label>
							<form:input path="tenhinhthuctt" cssClass="form-control" required="true"/>
						</div>
							<div class="form-group">
