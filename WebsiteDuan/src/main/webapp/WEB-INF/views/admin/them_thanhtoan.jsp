	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Thêm Thanh Toán</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-thanh-toan" modelAttribute="addThanhToan"
						method="POST">
						...
						<div class="form-group">
							...
							<form:input type="number" path="tongthanhtoan" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
