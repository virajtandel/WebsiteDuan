	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Cập Nhật Chủ Đề</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/update-chu-de" modelAttribute="updateChuDe"
						method="POST" enctype="multipart/form-data">
						<div class="form-group">
							<form:input path="idchude" cssClass="form-control" type="hidden"/>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Tên chủ đề</label>
							<form:input path="tenchude" cssClass="form-control" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Hình ảnh</label> <input
								...
								<img alt="" id="blah" src="/files/${showImg}" width="60%" class="mx-auto d-block mt-3">
								<a></a>
						</div>
						<div class="form-group">
						...
						<input type="hidden" value = "${showImg}" name="name-img-cu"  />
					</form:form>
				</div>
			</div>
		</div>
