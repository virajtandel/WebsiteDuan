...
<title>Thêm Loại Khóa Học</title>
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Thêm Loại Khóa Học</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-loai-khoa-hoc" modelAttribute="addLoaiKhoaHoc"
						method="POST">
						<div class="form-group">
							<label for="exampleInputEmail1">Tên loại khóa học</label>
							<form:input path="tenloaikh" cssClass="form-control" required="true" />
						</div>
						<div class="form-group">
