	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Thêm Trình Độ</h6>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<form:form action="/admin/add-trinh-do" modelAttribute="addTrinhDo"
						method="POST">
						<div class="form-group">
							<label for="exampleInputEmail1">Tên trình độ</label>
							<form:input path="tentrinhdo" cssClass="form-control" required="true"/>
						</div>
						<div class="form-group">
