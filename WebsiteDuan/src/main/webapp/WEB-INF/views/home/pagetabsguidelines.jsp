    ...
    <div class="container">
        <div class="row tt-row no-gutters">
            <div class="col-auto">
                ...
                <!-- logo -->
                <div class="tt-logo">
                    <a href="index"><img src="images/logo_forum.png" alt=""></a>
                </div>
                <!-- /logo -->
                <!-- desctop menu -->
                  <div class="tt-desktop-menu">
                        <nav>
                                <ul>
                                    <li><a href="pagecategories"><span>Danh mục</span></a></li>
                                    <li><a href="pagetabsguidelines"><span>Giới thiệu</span></a></li>
                                    <li>
                                        <a href="#"><span>Mở rộng</span></a>
                                        <ul>
                                        ...
                                        <li><a href="page-single_categories.html">Single User Categories</a></li> -->
                                            <li><a href="pagesinglesettings">Edit Profile</a></li>
                                            <li><a href="pagecategories">Danh mục</a></li>
                                            <!-- <li><a href="page-categories-single.html">Single Category</a></li> -->
                                            <li><a href="pagetabs">Giới thiệu</a></li>
                                            <li><a href="pagetabsguidelines">Hướng dẫn</a></li>
        ...
        <div class="tt-tab-wrapper">
            <div class="tt-wrapper-inner">
                <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-01" role="tab"><span>Giới thiệu</span></a>
                    </li>
                    <li class="nav-item show">
                        <a class="nav-link active" data-toggle="tab" href="#tt-tab-02" role="tab"><span>Hướng dẫn</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-03" role="tab"><span>Câu hỏi thường gặp</span></a>
                    </li>
                    <li class="nav-item tt-hide-xs">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-04" role="tab"><span>Điều khoản dịch vụ</span></a>
                    </li>
                    <li class="nav-item tt-hide-md">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-05" role="tab"><span>Bảo mật</span></a>
                    </li>
                </ul>
            </div>
            <div class="tab-content">
                <div class="tab-pane" id="tt-tab-01" role="tabpanel">
                    <div class="tt-layout-tab">
                        <div class="tt-wrapper-inner">
                            <h2 class="tt-title">
                               Giới thiệu về diễn đàn học tiếng Nhật Yuki.vn
                            </h2>
                            Yuki.vn là cộng đồng giúp kết nối những người có cùng đam mê học tiếng Nhật ở toàn cầu, cùng nhau chia sẻ để tiến tới thành công.
                            <h3 class="tt-title">
                                Admins
                            </h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="#" class="tt-avatar">
                                           ...
                                           <div class="tt-col-description">
                                               <h6 class="tt-title">HuyHoa</h6>
                                               <div class="tt-value">@hoahoa89</div>
                                           </div>
                                       </a>
                                   </div>
                                </div>
                        ...
                        <div class="table-responsive-sm tt-indent-top">
                            <table class="table-01">
                                <caption>Thống kê trang web</caption>
                                <thead>
                                    <tr>
                                        <th>Danh mục</th>
                                        <th>Tất cả</th>
                        ...
                        <div class="tt-wrapper-inner tt-indent-top">
                            ...
                            Xin vui lòng để lại cho chúng tôi một tin nhắn tại Yikuvn@gmail.com
                        </div>
                    </div>
                </div>
                <div class="tab-pane show active" id="tt-tab-02" role="tabpanel">
                    <div class="tt-wrapper-inner tt-layout-tab">
                        ...
                        <p>Yuki.vn là một cộng đồng sáng tạo cùng nhau chia sẻ ý tưởng và giúp nhau thành công.</p>
                        <p>
                            Chúng tôi mời bạn tham gia, nhưng có một vài quy tắc. Các quy tắc và giá trị dưới đây tồn tại để giúp bạn hiểu ý nghĩa của việc trở thành thành viên của cộng đồng và bao gồm tất cả các khía cạnh tương tác cộng đồng trên các diễn đàn, blog, cuộc thi và sự kiện của Yuki. Chúng tôi cam kết duy trì chúng và chúng tôi hy vọng bạn cũng sẽ như vậy.
                        </p>
                        <dl class="dl-layout-01">
                            <dt>Chúng tôi tin khi cộng đồng thành công, chúng tôi thành công.</dt>
                            <dd>
                                Chúng tôi yêu thích sự cạnh tranh lành mạnh, nhưng cảm thấy tất cả chúng ta đều tốt hơn khi chúng ta chia sẻ ý tưởng, kiến ​​thức và kỹ năng và giúp đỡ lẫn nhau. Chúng tôi đến để trả lại, không biết xấu hổ tự quảng bá.
                            </dd>
                            <dt>
                                Chúng tôi là một cộng đồng toàn cầu gồm nhiều loại người.
                            </dt>
                            <dd>
                                Chúng tôi đến từ mọi nơi trên trái đất và là nơi hội tụ của những lĩnh vực sáng tạo, trình độ kỹ năng, văn hóa, tôn giáo và nhiều hơn nữa. Chúng tôi nghĩ rằng cơ hội cho bất cứ ai đạt được thành công cho dù họ đến từ đâu dẫn đến một thế giới công bằng và bình đẳng hơn.
                            </dd>
                        </dl>
                        <h6 class="tt-title">Chúng tôi tuân theo một vài quy tắc cứng. Vui lòng KHÔNG:</h6>
                        <ul class="tt-list-dot tt-indent-top01">
                            <li>Tham gia hoặc khuyến khích các cuộc tấn công cá nhân, gọi người dùng khác và / hoặc phá hoại một mặt hàng của người dùng.</li>
                            <li>Thảo luận về chính trị, khiêu dâm, tôn giáo hoặc thị trường cạnh tranh.</li>
                            <li>Spam.</li>
                            <li>Liên kết với các phần mềm miễn phí trong danh mục các mặt hàng được bán trên Thị trường.</li>
                            <li>Yêu cầu hoặc đăng thông tin cá nhân (hoặc xác định) về bất kỳ người dùng hoặc bất kỳ người nào khác.</li>
                            <li>Nói về hoặc liên kết đến vi phạm bản quyền, warez, hoạt động bất hợp pháp của bất kỳ loại nào, hoặc các trang web hoặc mặt hàng của đối thủ cạnh tranh.</li>
                        </ul>
                        <p class="tt-indent-top02">
                            Chúng tôi tin rằng tất cả các ý tưởng có thể (và nên) được xem xét kỹ lưỡng, mang tính xây dựng.
                        </p>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="tt-tab-04" role="tabpanel">
                    <div class="tt-wrapper-inner tt-layout-tab">
                        Khi truy cập vào trang web Yuki.vn bạn phải cam kết rằng mình có đủ tuổi luật định và không phải là người bị hạn chế nhận các dịch vụ theo pháp luật để xác lập một hợp đồng có tính ràng buộc này. Bạn hiểu và đồng ý chấp nhận các chi phí cho việc tiếp cận trang web, việc tiếp cận này liên quan đến việc trả phí của bên thứ ba (như phí cho nhà cung cấp dịch vụ internet hoặc phí đường truyền, phí pháp lý, phí tư vấn hoặc các khoản chi phí khác) có thể phát sinh trực tiếp hoặc gián tiếp. Bạn cũng hiểu và tự chịu trách nhiệm hoàn toàn đối với các rủi ro có thể xãy ra cho việc bạn truy cập trang web, những rủi ro này liên quan đến những thiệt hại cho máy tính của bạn, hoặc thiết bị khác hoặc việc mất các dữ liệu do việc tải xuống các tài liệu bị virus; hành động phá hoại trực tiếp hay gián tiếp của hệ thống máy tính khác, đường dây điện thoại, phần mềm, lỗi chương trình hoặc bất kì các lỗi nào khác… Bạn hiểu và đồng ý rằng Dịch Vụ có thể bao gồm các thông tin quảng cáo, thông tin liên lạc của URL mà các thông tin này là một phần trong việc tham gia trang web của Yuki và bạn sẽ không thể từ chối nhận các thông tin này.
                    </div>
                </div>
...
<a href="pagecreatetopic" class="tt-btn-create-topic">
    <span class="tt-icon">
        <svg>
...
<svg width="0" height="0" class="hidden">
  ...
  <symbol aria-hidden="true" data-prefix="fab" data-icon="gmail" xmlns="http://www.w3.org/1999/svg" viewBox="-227 241 225.3 224.1" id="gmail-brands">
    <path fill="currentColor" d="M-132,241h-72.3c-12.4,0-22.6,10.2-22.6,22.6V336c0,12.4,10.2,22.6,22.6,22.6h72.3c12.4,0,22.6-10.2,22.6-22.6 v-72.3C-109.4,251.2-119.6,241-132,241z M-195.3,340.5c-7.5,0-13.6-6.1-13.6-13.6c0-7.5,6.1-13.6,13.6-13.6 c7.5,0,13.6,6.1,13.6,13.6C-181.8,334.4-187.9,340.5-195.3,340.5z M-195.3,286.2c-7.5,0-13.6-6.1-13.6-13.6 c0-7.5,6.1-13.6,13.6-13.6c7.5,0,13.6,6.1,13.6,13.6C-181.8,280.1-187.9,286.2-195.3,286.2z M-168.2,313.3 c-7.5,0-13.6-6.1-13.6-13.6c0-7.5,6.1-13.6,13.6-13.6s13.6,6.1,13.6,13.6C-154.7,307.3-160.7,313.3-168.2,313.3z M-141.1,340.5 c-7.5,0-13.6-6.1-13.6-13.6c0-7.5,6.1-13.6,13.6-13.6c7.5,0,13.6,6.1,13.6,13.6C-127.5,334.4-133.6,340.5-141.1,340.5z M-141.1,286.2c-7.5,0-13.6-6.1-13.6-13.6c0-7.5,6.1-13.6,13.6-13.6c7.5,0,13.6,6.1,13.6,13.6C-127.5,280.1-133.6,286.2-141.1,286.2
    z"></path>
  </symbol>
