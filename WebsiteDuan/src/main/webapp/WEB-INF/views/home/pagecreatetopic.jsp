        ...
        <div class="container">
            <div class="tt-wrapper-inner">
                ...
                <form class="form-default form-create-topic">
                    <div class="form-group">
                        <label for="inputTopicTitle">Tiêu đề bài viết</label>
                        <div class="tt-value-wrapper">
                            <input type="text" name="name" class="form-control" id="inputTopicTitle"
                                placeholder="Nhập mô tả về bài viết của bạn">
                            <span class="tt-value-input">99</span>
                        </div>
                        <div class="tt-note">Mô tả bài viết của bạn thật ngắn
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="row tt-w410-col-02">
                                <div class="col-4 col-lg-3 col-xl-2">
                                    <a href="#" class="tt-button-icon">
                                        ...
                                        <span class="tt-text">Thảo luận</span>
                                    </a>
                                </div>
                                <div class="col-4 col-lg-3 col-xl-2">
                                    <a href="#" class="tt-button-icon">
                                        ...
                                        <span class="tt-text">Câu hỏi</span>
                                    </a>
                                </div>
                                <div class="col-4 col-lg-3 col-xl-2">
                                    <a href="#" class="tt-button-icon">
                                        ...
                                        <span class="tt-text">Thăm dò ý kiến</span>
                                    </a>
                                </div>
                                <div class="col-4 col-lg-3 col-xl-2">
                                    <a href="#" class="tt-button-icon">
                                        ...
                                        <span class="tt-text">Bộ sưu tập</span>
                                    </a>
                                </div>
                                <div class="col-4 col-lg-3 col-xl-2">
                                    <a href="#" class="tt-button-icon">
                    ...
                    <div class="pt-editor">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="inputTopicTitle">Danh mục</label>
                                    <select class="form-control">
                                        <option value="Select">Thắc mắc</option>
                                        <option value="Value 01">Thảo luận</option>
                                        <option value="Value 02">Giải trí</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="inputTopicTags">Thẻ mô tả</label>
                        ...
                        <div class="row">
                            <div class="col-auto ml-md-auto">
                                <a href="#" class="btn btn-secondary btn-width-lg">Tạo bài viết</a>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="tt-topic-list tt-offset-top-30">
                <div class="tt-list-search">
                    <div class="tt-title">Đề xuất bài viết</div>
                    <!-- tt-search -->
                    <div class="tt-search">
                        <form class="search-wrapper">
                            <div class="search-form">
