        ...
        <div class="container">
            <div class="tt-single-topic-list">
                    ...
                    <div class="tt-single-topic">
                        <div class="tt-item-header">
                            ...
                            <h3 class="tt-item-title">
                                <a href="#">Phương pháp tự học tiếng Nhật cho người mới bắt đầu</a>
                            </h3>
                            <div class="tt-item-tag">
                                <ul class="tt-list-badge">
                                    <li><a href="#"><span class="tt-color03 tt-badge">Tiếng Nhật</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Bắt đầu</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Tự học</span></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="tt-item-description">
                            <h6 class="tt-title">1. Phương pháp học tiếng Nhật theo chiều rộng</h6>
                            <p>
                                Đa phần các bạn học ngoại ngữ đều thường cố gắng đạt đến sự hoàn hảo ngay từ khi bắt đầu
                                học tiếng Nhật, học thuộc 100% từ mới, phát âm chuẩn 100%, nhớ 100% ngữ pháp…
                            </p>
                            <p>
                                Quan điểm của mình là không cần thiết phải học như vậy khi mới bắt đầu. Học chính xác
                                100% sẽ tốn rất nhiều thời gian. Thay vì dành 10h thời gian học thuộc 1 bài 100% thì
                                dành 10h để học 2 bài mỗi bài thuộc 80% sẽ tốt hơn. Quan điểm này cũng được áp dụng với
                                các lớp dành cho người mới bắt đầu của chúng tôi.
                            </p>
                            <h6 class="tt-title">2. Phương pháp học từ mới</h6>
                            <p>
                                Để đạt trình độ sơ cấp tiếng Nhật N5 (Trình độ giao tiếp cơ bản của tiếng Nhật), bạn cần
                                học thuộc khoảng 800 từ mới. Phải nói thêm rằng học từ mới tiếng Nhật khó hơn nhiều so
                                với các ngôn ngữ khác vì tiếng Nhật sử dụng tới 3 bảng chữ cái, những bạn mới học tiếng
                                Nhật chưa quen với bảng chữ cái tiếng Nhật sẽ gặp nhiều khó khăn để nhớ từ. Vì vậy nếu
                                tự học tiếng Nhật, có thể bạn phải mất cả năm để học từ mà vẫn hay quên.
                            </p>
                        </div>
                ...
                <div class="tt-item">
                    <div class="tt-info-box">
                        <h6 class="tt-title">Tình trạng bài viết</h6>
                        ...
                        <hr>
                        <h6 class="tt-title">Những người xem thường xuyên</h6>
                        <div class="tt-row-icon">
                            <div class="tt-item">
                        ...
                        <div class="row-object-inline form-default">
                            <h6 class="tt-title">Sắp xếp trả lời theo:</h6>
                            <ul class="tt-list-badge tt-size-lg">
                                <li><a href="#"><span class="tt-badge">Gần đây</span></a></li>
                                <li><a href="#"><span class="tt-color02 tt-badge">Nhiều lượt thích nhất</span></a></li>
                                <li><a href="#"><span class="tt-badge">Dài nhất</span></a></li>
                                <li><a href="#"><span class="tt-badge">Ngắn nhất</span></a></li>
                                <li><a href="#"><span class="tt-badge">Câu trả lời được chấp nhận</span></a></li>
                            </ul>
                ...
                <div class="tt-item">
                    <div class="tt-single-topic">
                        ...
                        <div class="tt-item-description">
                            <p>
                                Các bạn mới bắt đầu nên học bảng phát âm chữ cái này trước đã
                            </p>
                            <p>
                    ...
                    <div class="tt-single-topic">
                        <div class="tt-item-header pt-noborder">
                            <div class="tt-item-info info-top">
                                ...
                                <div class="tt-avatar-title">
                                    <a href="#">tesla02</a>
                                    <span class="tt-color13 tt-badge">Câu trả lời hay nhất</span>
                                </div>
                                <a href="#" class="tt-info-time">
                                    <i class="tt-icon"><svg>
                                            <use xlink:href="#icon-time"></use>
            ...
            <div class="tt-topic-list tt-ofset-30">
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="page-single-topic.html">
                                Cách luyện nghe tiếng Nhật hiệu quả
                            </a></h6>
                        <div class="row align-items-center no-gutters">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color04 tt-badge">Chia
                                                sẻ</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Kĩ năng</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Nghe</span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="tt-col-category"><span class="tt-color04 tt-badge">Chia sẻ</span></div>
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="page-single-topic.html">
                                Các bài hát tiếng Nhật hay nhất !!!
                            </a></h6>
                        <div class="row align-items-center no-gutters  ">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color05 tt-badge">Chia
                                                sẻ</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Music</span></a></li>
                                    <li><a href="#"><span class="tt-badge">Japan</span></a></li>
                                </ul>
                            </div>
                            <div class="col-1 ml-auto show-mobile">
                                <div class="tt-value">1d</div>
                    ...
                    <div class="tt-col-category"><span class="tt-color05 tt-badge">Chia sẻ</span></div>
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="page-single-topic.html">
                                ...
                                Mình mới học tiếng nhật thì nên bắt đầu từ đâu ạ??
                            </a></h6>
                        <div class="row align-items-center no-gutters  hide-desktope">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color06 tt-badge">Thắc
                                                mắc</span></a></li>
                                </ul>
                            </div>
                            <div class="col-1 ml-auto show-mobile">
                    ...
                    <div class="tt-col-category"><span class="tt-color06 tt-badge">Thắc mắc</span></div>
                ...
                <div class="tt-item tt-item-popup">
                    ...
                    <div class="tt-col-message">
                        Hình như bạn là người mới ở đây. Đăng ký miễn phí, học hỏi và đóng góp.
                    </div>
                    <div class="tt-col-btn">
